...
let AppController = (() => {
    ...
    let _Ejemplo_decorators;
    let _getIdenticifacion_decorators;
    ...
    (() => {
        ...
        _Ejemplo_decorators = [(0, common_1.Get)('ejemplo')];
        _getIdenticifacion_decorators = [(0, common_1.Get)('identificacion/:id/:nombre')];
        ...
        __esDecorate(_classThis, null, _Ejemplo_decorators, { kind: "method", name: "Ejemplo", static: false, private: false, access: { has: obj => "Ejemplo" in obj, get: obj => obj.Ejemplo }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _getIdenticifacion_decorators, { kind: "method", name: "getIdenticifacion", static: false, private: false, access: { has: obj => "getIdenticifacion" in obj, get: obj => obj.getIdenticifacion }, metadata: _metadata }, null, _instanceExtraInitializers);
